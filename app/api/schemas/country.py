...
class CountryCreate(BaseModel):
    ...
    code: str = Field(..., min_length=2, max_length=2, description="ISO 3166-1 alpha-2 国コード")
...
class CountryUpdate(BaseModel):
    ...
    code: str | None = Field(None, min_length=2, max_length=2, description="ISO 3166-1 alpha-2 国コード")
